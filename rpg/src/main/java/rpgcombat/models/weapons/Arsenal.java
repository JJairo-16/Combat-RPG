...
import static rpgcombat.models.weapons.WeaponType.*;

import java.util.Arrays;
import java.util.Comparator;
import java.util.List;

import static rpgcombat.models.weapons.passives.Passives.*;
import rpgcombat.models.weapons.passives.WeaponPassive;
